...
<br/>
![insert photo of Jenny and couch with image detection](./dog-off-couch/JennyAndCouchWithAIBoxes.jpeg)
<br/>
...
<br/>
<center>
    <iframe class="flex justify-center" width="560" height="315" src="https://www.youtube.com/embed/J1c4TYoAqGA?si=XCJSEnRtoaowGiqZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</center>
<br/>
And just like that, Jenny has learned the couch is not where she belongs and has not been back since! 
<br />
![Jenny laying in front of couch](./dog-off-couch/JennyInFrontOfCouch.jpeg)
<br />
